...
def parse_args():
    ...
    parser.add_argument('--lr_steps', default=[40, 80],
                        help='lr step')
    parser.add_argument('--imgs_per_gpu', default=8,
                        help='imgs per gpu')
    ...
    parser.add_argument('--mom', default=0.9,
                        help='momentum')
    parser.add_argument('--weight_decay', default=0.0000,
                        help='weight decay')
...
def main():
    ...
    train_ann_file = args.data_dir + "/kinetics400/kinetics400_train_list_videos_sub.txt"
    ...
    train_dataset=VideoDataset(ann_file=train_ann_file,
    ...
    val_dataset = VideoDataset(ann_file=val_ann_file,
    ...
    for epoch in range(args.epochs):
        ...
        for i, data_batch in enumerate(train_data_loader):
            ...
            if i % print_interval == 0:
                ...
                print('epoch {} train iter {} oneflow loss {}, lr: {}, train time : {}'.format(epoch, i, l, tmp_lr, end_t - start_t))
        ...
        if epoch % val_interval == 0:
            ...
            print("epoch %d, oneflow top1 val acc: %f, top5 val acc: %f" % (epoch, top1, top5))
            flow.save(model.state_dict(), os.path.join(args.save_checkpoint_path, "epoch_%d_val_acc_%f" % (epoch, top1)))
