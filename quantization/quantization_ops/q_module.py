...
class QParam:
    ...
    def __init__(self, quantization_bit=8, quantization_scheme='symmetric', quantization_formula='google', per_layer_quantization=True):
        ...
        self.min_max_observer = flow.nn.MinMaxObserver(quantization_formula=quantization_formula, quantization_bit=quantization_bit,
...
class QModule(nn.Module):
    ...
    def __init__(self, qi=True, qo=True, quantization_bit=8, quantization_scheme='symmetric', quantization_formula='google', per_layer_quantization=True):
        ...
        if qi:
            self.qi = QParam(quantization_bit=quantization_bit, quantization_scheme=quantization_scheme,
                             quantization_formula=quantization_formula, per_layer_quantization=per_layer_quantization)
        if qo:
            self.qo = QParam(quantization_bit=quantization_bit, quantization_scheme=quantization_scheme,
                             quantization_formula=quantization_formula, per_layer_quantization=per_layer_quantization)
