...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--kwargs_path", type=str, default="./roberta-base-oneflow/parameters.json"
    )
    parser.add_argument(
        "--pretrain_dir", type=str, default="./roberta-base-oneflow/weights"
    )
    parser.add_argument("--model_save_dir", type=str, default="./pretrain_model_SST-2")
