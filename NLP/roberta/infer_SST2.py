...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_load_dir", type=str, default="./pretrain_model_SST-2")
    parser.add_argument(
        "--kwargs_path", type=str, default="./flow_roberta-base/parameters.json"
    )
    parser.add_argument(
        "--pretrain_dir", type=str, default="./flow_roberta-base/weights"
    )
    parser.add_argument(
        "--text", type=str, default="this is junk food cinema at its greasiest ."
    )
