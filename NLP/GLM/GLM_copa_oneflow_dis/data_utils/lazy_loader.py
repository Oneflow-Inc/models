...
class LazyWriter:
    def __init__(self, path, data_type, is_array=False, array_data_type=np.int32):
        ...
        #lazypath:./other/dataset/glm_train.lazy
...
class LazyLoader(object):
    ...
    def __init__(self, path, data_type='data', mem_map=False, map_fn=None, is_array=False, array_data_type=np.int32,
        ...
        lazypath = get_lazy_path(path)                  #./other/dataset/glm_train.lazy
        datapath = os.path.join(lazypath, data_type)    #./other/dataset/glm_train.lazy/text
        ...
        lenpath = os.path.join(lazypath, data_type + '.len.pkl')  #./other/dataset/glm_train.lazy/text.len.pkl
