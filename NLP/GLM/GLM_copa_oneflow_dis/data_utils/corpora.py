...
class DataReader:
    ...
    def __init__(self, writers, tokenizer=None, tokenize=False, **kwargs):
        ...
        self.tokenizer = tokenizer #dict
        self.tokenize = tokenize   #True
        self.writers = writers     #writers = {'prompt': prompt_writer, 'text': text_writer}
    ...
    def process(self):
        if os.path.isdir(self.PATH):
            ...
            paths = [self.PATH] #['./other/dataset/glm_train.txt']
