...
class ConstructBlockStrategy:
    ...
    def construct_blocks(self, samples):
        # print(samples[0]['text'].shape)
        # print(samples[1]['text'].shape)
        # print(samples[2]['text'].shape)
        # print(samples[3]['text'].shape)
        # print(samples[0]['loss_mask'].shape)
        # print(samples[1]['loss_mask'].shape)
        # print(samples[2]['loss_mask'].shape)
        # print(samples[3]['loss_mask'].shape)
        ...
        if self.encoder_decoder:
            ...
            # print(token_batch[0].shape)
            # print(token_batch[1].shape)
            # print(token_batch[2].shape)
            # print(token_batch[3].shape)
            # print(22222222222)
            # print(target_batch[0].shape)
            # print(target_batch[1].shape)
            # print(target_batch[2].shape)
            # print(target_batch[3].shape)
            # print(333333333333)
            # print(loss_mask_batch[0].shape)
            # print(loss_mask_batch[1].shape)
            # print(loss_mask_batch[2].shape)
            # print(loss_mask_batch[3].shape)
            # print(444444444444444)
            # print(position_id_batch[0].shape)
            # print(position_id_batch[1].shape)
            # print(position_id_batch[2].shape)
            # print(position_id_batch[3].shape)
            # exit(0)
    ...
    def pad_batch(self,token_batch, target_batch, loss_mask_batch, position_id_batch):
        ...
        max_length = self.args.seq_length + 40
