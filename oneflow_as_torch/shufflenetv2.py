...
if __name__ == "__main__":
    ...
    print(f"shufflenet_v2_x0_5 output: {net(input).shape}")
    net = shufflenet_v2_x1_0()
    print(f"shufflenet_v2_x1_0 output: {net(input).shape}")
    net = shufflenet_v2_x1_5()
    print(f"shufflenet_v2_x1_5 output: {net(input).shape}")
    net = shufflenet_v2_x2_0()
    print(f"shufflenet_v2_x2_0 output: {net(input).shape}")