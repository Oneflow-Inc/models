...
class InceptionA(nn.Module):
    ...
    def __init__(
        ...
        self.pool_layer = nn.AvgPool2d(kernel_size=3, stride=1, padding=1)
...
class InceptionC(nn.Module):
    ...
    def __init__(
        ...
        self.pool_layer = nn.AvgPool2d(3, 1, 1)
...
class InceptionAux(nn.Module):
    ...
    def __init__(
        ...
        self.pool_layer = nn.AvgPool2d(kernel_size=5, stride=3)
