...
if __name__ == "__main__":
    ...
    small_net = mobilenet_v3_small()
    print(f"mobilenet_v3_small output: {small_net(input).shape}")
    large_net = mobilenet_v3_large()
    print(f"mobilenet_v3_large output: {large_net(input).shape}")