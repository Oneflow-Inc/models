...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        for idx, stage_idx in enumerate(range(2, max_stage_idx + 1)):
            ...
            stage_kargs = {
                ...
                "requires_grad": False if idx < freeze_stage else True,
            ...
            if depth in [18, 34]:
                ...
                stage_kargs["groups"] = num_groups
                stage_kargs["block"] = Bottleneck

            if in_channels != out_channels:
                stage_kargs["downsample"] = nn.Sequential(
    ...
    def make_stage(
            self, block: Type[Union[BasicBlock, Bottleneck]], stride, num_blocks, in_planes, out_planes, **kwargs
    ):
        blocks = []
        for i in range(num_blocks):
            stride_per_block = stride[i]
            print("block in and out", i, "of", num_blocks,":", in_planes, out_planes, block, stride_per_block)
        ...
        return nn.Sequential(*blocks).to('cuda')
