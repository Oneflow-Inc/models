...
from easynlp.fewshot_learning.fewshot_evaluator import (
    PromptEvaluator as FewshotSequenceClassificationEvaluator,
)
from easynlp.fewshot_learning.fewshot_evaluator import (
    CPTEvaluator as CptFewshotSequenceClassificationEvaluator,
)
