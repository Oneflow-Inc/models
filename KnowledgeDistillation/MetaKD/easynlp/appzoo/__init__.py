...
_import_structure = {
    ...
    "sequence_classification.evaluator": [
    ...
    "sequence_classification.predictor": [
    ...
    "sequence_labeling.data": [
        "SequenceLabelingDataset",
        "SequenceLabelingAutoDataset",
    ],
    "text_match.data": [
        "TwoTowerDataset",
        "SingleTowerDataset",
...
if TYPE_CHECKING:
    ...
    from .sequence_classification.predictor import (
        SequenceClassificationPredictor,
        FewshotSequenceClassificationPredictor,
        CptFewshotSequenceClassificationPredictor,
    )
    ...
    from .text_match.predictor import (
        TextMatchPredictor,
        TextMatchTwoTowerPredictor,
        FewshotSingleTowerTextMatchPredictor,
        CptFewshotSingleTowerTextMatchPredictor,
    ...
    from .sequence_classification.data import (
        ClassificationDataset,
        DistillatoryClassificationDataset,
        FewshotSequenceClassificationDataset,
    )
    from .sequence_labeling.data import (
        SequenceLabelingDataset,
        SequenceLabelingAutoDataset,
    )
    from .language_modeling.data import LanguageModelingDataset
    from .text_match.data import (
        TwoTowerDataset,
        SingleTowerDataset,
        DistillatorySingleTowerDataset,
        FewshotSingleTowerTextMatchDataset,
