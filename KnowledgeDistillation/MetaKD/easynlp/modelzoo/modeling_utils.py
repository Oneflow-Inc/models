# coding=utf-8
# Copyright 2018 The Google AI Language Team Authors, Facebook AI Research authors, The HuggingFace Inc. team, and Alibaba PAI Team.
...
from oneflow import Tensor, device, dtype, nn
...
class PreTrainedModel(nn.Module, ModuleUtilsMixin, GenerationMixin, PushToHubMixin):
    ...
    def _load_state_dict_into_model(
        ...
        return load_state_dict_into_model(
            cls, model, state_dict, pretrained_model_name_or_path, _fast_init=_fast_init
        )
