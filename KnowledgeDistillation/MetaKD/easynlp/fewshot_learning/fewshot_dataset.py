...
class FewshotBaseDataset(BaseDataset):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(FewshotBaseDataset, self).__init__(
            data_file, input_schema=input_schema, output_format="dict", **kwargs
        )
    ...
    def convert_single_row_to_example(self, row):
        ...
        assert len(label_tokens) == self.masked_length, (
            "label length %d should be equal to the mask length %d"
        ...
        for p in self.pattern:
            if p == self.first_sequence:
                ...
                tokens += [self.tokenizer.mask_token,] * self.masked_length
