...
class FewshotClassification(Application):
    ...
    def __init__(
        self, pretrained_model_name_or_path=None, user_defined_parameters=None, **kwargs
    ):
    ...
    def compute_loss(self, forward_outputs, label_ids):
        ...
        masked_lm_loss = cross_entropy(
            prediction_scores.view(-1, self.config.vocab_size), label_ids.view(-1)
        )
...
class CPTClassification(FewshotClassification):
    ...
    def __init__(
        ...
        super(CPTClassification, self).__init__(
            pretrained_model_name_or_path, user_defined_parameters, **kwargs
        )
