...
if __name__ == "__main__":
    ...
    model = MetaStudentForSequenceClassification(pretrained_model_name_or_path=user_defined_parameters['student_config_path'], num_labels=2, num_domains=4)
    model.load_state_dict(torch.load(user_defined_parameters['student_model_path'] + "/oneflow_model"))
