...
if __name__ == "__main__":
    ...
    m  = _shufflenetv2('shufflenetv2_x0.5', [4, 8, 4], [24, 48, 96, 192, 1024])
    print("yaochi:", m)

    parameters = torch.load("/home/yaochi/models/shufflenetv2/models/shufflenetv2_x0.5-f707e7126e.pth")
