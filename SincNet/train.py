...
for epoch in range(N_epochs):
    ...
    if epoch % N_eval_epoch == 0:
        ...
        print(
            ...
            % (epoch, loss_tot.numpy(), err_tot, loss_tot_dev.numpy(), err_tot_dev,
               err_tot_dev_snt))
        ...
        flow.save(CNN_net.state_dict(), os.path.join(output_folder, "CNN_epoch_%d" % epoch))
        flow.save(DNN1_net.state_dict(), os.path.join(output_folder, "DNN1_epoch_%d" % epoch))
        flow.save(DNN2_net.state_dict(), os.path.join(output_folder, "DNN2_epoch_%d" % epoch))
