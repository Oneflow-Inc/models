...
parquet_to_raw(tests, "/RAID0/criteo1t_oneflow_raw/test")
parquet_to_raw(vals, "/RAID0/criteo1t_oneflow_raw/val")
parquet_to_raw(trains, "/RAID0/criteo1t_oneflow_raw/train")
