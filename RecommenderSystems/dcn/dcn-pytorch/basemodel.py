...
class BaseModel(nn.Module):
    ...
    def fit(self, x=None, y=None, batch_size=None, epochs=1, verbose=1, initial_epoch=0, validation_split=0.,
            validation_data=None, shuffle=True, callbacks=None, model_path=None):
        """
            ...
            try:
                with tqdm(enumerate(train_loader), disable=verbose != 1) as t:
                    ...
                    for _, (x_train, y_train) in t:
                        end_1 = time.time()
                        self.time_dict['load data']+=(end_1-start_1)
                        ...
                        end_2 = time.time()
                        self.time_dict['forward']+=(end_2-start_2)
                        ...
                        optim.zero_grad()
                        end_3 = time.time()
                        self.time_dict['zero grad']+=(end_3-start_3)
                        ...
                        end_4 = time.time()
                        self.time_dict['loss']+=(end_4-start_4)

                        start_5 = time.time()
                        loss_epoch += loss.item()
                        total_loss_epoch += total_loss.item()
                        end_5 = time.time()
                        self.time_dict['loss.item']+=(end_5-start_5)

                        start_6 = time.time()
                        total_loss.backward()
                        end_6 = time.time()
                        self.time_dict['backward']+=(end_6-start_6)


                        start_7 = time.time()
                        optim.step()
                        end_7 = time.time()
                        self.time_dict['optimizer step']+=(end_7-start_7)                       
        ...
        for time_key in self.time_dict:
            print('=====',time_key,'=====',self.time_dict[time_key]/epochs)
