...
class OfRecordDataLoader(nn.Module):
    ...
    def forward(self):
        ...
        if self.use_consistent and self.data_part_num < self.world_size:
            ...
            next_sent_labels = next_sent_labels.to_consistent(placement=placement, sbp=sbp)
            ...
            masked_lm_positions = masked_lm_positions.to_consistent(placement=placement, sbp=sbp)
            masked_lm_weights = masked_lm_weights.to_consistent(placement=placement, sbp=sbp)
