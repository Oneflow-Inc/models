...
train_data = flow.Tensor(np.random.uniform(size=(30, 1, 32, 32)).astype(np.float32), device="cuda")
train_label = flow.Tensor(np.random.uniform(size=(30)).astype(np.int32), dtype=flow.int32, device="cuda")
