...
parser.add_argument('--hr_name', default='data/Set14/HR/monarch.png', type=str,
                    help='test low resolution image name')
parser.add_argument('--save_image', default='data/Set14/SR/monarchx4-oneflow.png', type=str,
                    help='super resolution image name')
parser.add_argument('--model_name', default="netG_epoch_4_99", type=str, help='generator model epoch name')
