...
def parse():
    ...
    parser.add_argument("--checkpoint-path", metavar='DIR',
                        default="./torch_checkpoints", help="path to checkpoint save")
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.local_rank == 0:
            ...
            }, is_best, os.path.join(args.checkpoint_path, "checkpoint.pth.tar"))
...
def save_checkpoint(state, is_best, filename='checkpoint.pth.tar'):
    ...
    if is_best:
        filename_best = os.path.join(os.path.dirname(filename), 'model_best.pth.tar')
