...
class Roberta(nn.Module):
    ...
    def __init__(self, vocab_size, type_vocab_size=2, max_position_embeddings=512,
        ...
        self.embeddings = RobertaEmbeddings(vocab_size, max_position_embeddings, type_vocab_size,
                                            hidden_size, layer_norm_eps, hidden_dropout, pad_token_id, position_embedding_type)
        self.encoder = RobertaEncoder(num_layers, max_position_embeddings, hidden_size, intermediate_size, nheads, activation,
