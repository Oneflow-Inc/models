...
DISABLE_TELEMETRY = os.getenv(
    "DISABLE_TELEMETRY", False) in ENV_VARS_TRUE_VALUES
...
_staging_mode = os.environ.get(
    "HUGGINGFACE_CO_STAGING", "NO").upper() in ENV_VARS_TRUE_VALUES
...
class PushToHubMixin:
    ...
    def _create_or_get_repo(
        ...
        repo = Repository(repo_path_or_name, clone_from=repo_url,
                          use_auth_token=use_auth_token)
        repo.git_pull()
        return repo
