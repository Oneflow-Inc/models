...
def bytes_to_unicode():
    """
    Returns list of utf-8 byte and a corresponding list of unicode strings. We specifically avoids mapping to whitespace/control
...
class GPT2Tokenizer(object):
    ...
    def convert_ids_to_tokens(self, ids, skip_special_tokens=False):
        ...
        for i in ids:
            if i in self.special_tokens_decoder:
                ...
                tokens.append(self.decoder.get(i))
        return tokens
    ...
    def save_vocabulary(self, save_directory):
        ...
        merge_file = os.path.join(save_directory, MERGES_NAME)
        special_tokens_file = os.path.join(save_directory, SPECIAL_TOKENS_NAME)
