...
def main():
    ...
    model.load_state_dict(torch.load("test_gpt2_model.pt"))
    ...
    pt_optimizer = torch.optim.Adam(model.parameters(), lr=0.001, betas=(args.adam_beta1, args.adam_beta2), weight_decay=args.adam_weight_decay)
