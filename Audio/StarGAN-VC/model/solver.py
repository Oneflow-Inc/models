...
class Solver(object):
    ...
    def train(self):
        ...
        for i in range(start_iters, self.num_iters):
            ...
            d_loss_t = nn.BCEWithLogitsLoss()(input=out_f, target=flow.zeros_like(out_f).float()) + \
                nn.BCEWithLogitsLoss()(input=out_r, target=flow.ones_like(out_r).float())
