...
def main(config):
    ...
    # Data loader.
    dloader = data_loader(config.data_dir, batch_size=config.batch_size,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lambda_cycle', type=float,
                        default=3, help='weight for cycle loss')
    ...
    parser.add_argument('--lambda_identity', type=float,
                        default=2, help='weight for identity loss')
    ...
    parser.add_argument('--pretrain_models', type=str,
                        default='./pretrain_models', help='dictionary for pretrain models')
    parser.add_argument('--src_speaker', type=str,
                        default=None, help='test model source speaker')
    parser.add_argument('--trg_speaker', type=str,
                        default="['SF1', 'TM1']", help='string list repre of target speakers eg."[a,b]"')
    ...
    parser.add_argument('--use_gradient_penalty', type=bool, default=None)
