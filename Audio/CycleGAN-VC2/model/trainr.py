...
class CycleGANTrainr(object):
    ...
    def saveModelCheckPoint(self, epoch, PATH):
        flow.save(self.generator_A2B.state_dict(), os.path.join(PATH, "generator_A2B_%d" % epoch))
        flow.save(self.generator_B2A.state_dict(), os.path.join(PATH, "generator_B2A_%d" % epoch))
        flow.save(self.discriminator_A.state_dict(), os.path.join(PATH, "discriminator_A_%d" % epoch))
        flow.save(self.discriminator_B.state_dict(), os.path.join(PATH, "discriminator_B_%d" % epoch))
