...
from utils.finetune import train_one_epoch, evaluate
...
def main(args):
    ...
    if True:  # args.distributed:
        ...
        if args.dist_eval:
            ...
            sampler_val = flow.utils.data.DistributedSampler(
    ...
    if args.finetune and not args.eval:
        checkpoint = flow.load(args.finetune)
    ...
    if args.distributed:
        model = flow.nn.parallel.DistributedDataParallel(model)
        model_without_ddp = model
