...
from flowvision.models.vision_transformer import PatchEmbed, Block
...
class MaskedAutoencoderViT(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
        ...
        self.mask_token = nn.Parameter(flow.zeros(1, 1, decoder_embed_dim))
    ...
    def random_masking(self, x, mask_ratio):
        ...
        noise = flow.rand(N, L, device=x.device)  # noise in [0, 1]
        ...
        mask = flow.ones([N, L], device=x.device)
        mask[:, :len_keep] = 0
