...
class Trainer(object):
    def __init__(self):
        ...
        profiler_start()
        range_push('init_model')
        self.init_model()
        range_pop()
        self.cross_entropy = make_cross_entropy(args)

        range_push('make_data_loader')
    ...
    def train_one_epoch(self):
        ...
        for _ in range(self.nsight_step):
            if self.graph:
                range_push('train iter >>> train_graph')
            ...
            range_push('train iter >>> meter to local')
            ...
            range_push('train iter >>> meter_train_iter')
