...
def _parse_args():
    parser = argparse.ArgumentParser("flags for train ghostnet")
    parser.add_argument(
...
def main(args):
    ...
    if args.load_checkpoint != "":
        net_module.load_state_dict(flow.load(args.load_checkpoint))
    end_t = time.time()
    ...
    of_sgd = flow.optim.SGD(
        net_module.parameters(), lr=args.learning_rate, momentum=args.mom
    )
