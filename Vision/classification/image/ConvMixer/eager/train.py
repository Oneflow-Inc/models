...
from models.conv_mixer import ConvMixer, build_model
...
def _parse_args():
    parser = argparse.ArgumentParser("flags for train ConvMixer")
    parser.add_argument(
        "--model",
        type=str,
        default="convmixer_768_32",
        choices=["convmixer_768_32", "convmixer_1536_20", "convmixer_1024_20"],
