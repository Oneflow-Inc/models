...
from flowvision.models.inception_v3 import InceptionA, InceptionC, InceptionE
try:
...
FID_WEIGHTS_URL = 'https://oneflow-public.oss-cn-beijing.aliyuncs.com/model_zoo/inception_fid_oneflow.zip'
