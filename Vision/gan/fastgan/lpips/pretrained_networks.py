...
from flowvision import models as tv
...
class squeezenet(flow.nn.Module):
    def __init__(self, requires_grad=False, pretrained=True):
        ...
        self.slice5 = flow.nn.Sequential()
        self.slice6 = flow.nn.Sequential()
        self.slice7 = flow.nn.Sequential()
        self.N_slices = 7
        for x in range(2):
