...
def _parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default='',
        help="input image original file")

    parser.add_argument(
        "--split_p",
        type=float,
        default=0.85,
        help="image split probability")
...
def main(args):
    ...
    if not os.path.exists(train_json) or train_json is '':
        print('train json is not exist')
        return -1

    file = open(train_json)
